...
<?php 
/* Template Name: Keuze (Brievenbus) */ 
get_header();
?>
<?php
        ...
        <div class="row align-items-center ">
            ...
            <div class="col-lg-7 col-md-8 col-sm-12  md-full  norightpadding text-center">
                ...
                <div class="user-text d-flex align-items-center justify-content-center">
                    <div class="user-img">
                        <img src="<?php echo $quote_author_image['url']; ?>" alt="<?php echo $images_alt; ?>">
                    </div>
            ...
            <div class="gift-list-section">
                ...
                <div class="product-gifts-list-wrapper">
                    <div class="product-gifts-filter">
                        <select name="product_cat_filter" class="product_cat_filter" multiple="multiple">
        ...
        <div class="container link-cases content_align_<?= $cta_content_alignment; ?>">
            <div class="row cases-box" <?php if($cat_is_background=='1'):?>style="background:<?= $cta_background_color; ?>"<?php endif; ?>>
                ...
                <?php  if(!empty($cta_image)):
                    ...
                    ?>
                    <div class="col-md-4">
                        <img class="w-100" src="<?= $cta_image['url']; ?>" alt="<?php echo $images_alt; ?>" />
                    </div>
                <?php endif; ?>
            </div>
        </div>
...
if( have_rows('customized_image__video_section') ):
    ...
    ?>
    <section class="customized_image_video_5_<?= $i ?> w-100 section_4  section-customized_image__video_section column-reverse">
        <?php
