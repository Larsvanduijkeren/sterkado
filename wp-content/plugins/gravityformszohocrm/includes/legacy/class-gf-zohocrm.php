...
class GFZohoCRM extends GFFeedAddOn {
	...
	public function display_update_authentication_message() {
		...
		printf( '<div class="notice notice-error gf-notice"><p>%s</p></div>', $message );

	}

	/**
	 * Check whether this add-on needs to be reauthenticated with the Zoho API.
	 *
	 * @since 1.12.14
	 *
	 * @return bool
	...
	public function update_auth_token( $field, $field_value ) {
		...
		try {
			...
			// Save the authentication version
