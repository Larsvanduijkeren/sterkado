...
include_once(self::$path . "templates/feed-account.php");
  ...
  */
  ...
  array_push($form['fields'],array("id" => "date_created" , "label" => esc_html__("Entry Date", 'gravity-forms-zoho-crm')));
  array_push($form['fields'],array("id" => "ip" , "label" => esc_html__("User IP", 'gravity-forms-zoho-crm')));
  array_push($form['fields'],array("id" => "source_url" , "label" => esc_html__("Source Url", 'gravity-forms-zoho-crm')));
  array_push($form['fields'],array("id" => "form_title" , "label" => esc_html__("Form Title", 'gravity-forms-zoho-crm')));
  array_push($form['fields'],array("id" => "status" , "label" => esc_html__('Entry Status', 'gravity-forms-zoho-crm')));
  ...
  $this->fields=$fields=array('gf'=>array("title"=>__('Gravity Forms Fields','gravity-forms-zoho-crm'),"fields"=>$fields));
