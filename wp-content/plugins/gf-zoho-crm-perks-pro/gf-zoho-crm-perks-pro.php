<?php
/**
* Plugin Name: WP Gravity Forms Zoho Add-on Pro
...
public function do_actions(){
  ...
  */
  ...
  $this->api=$api= new vxg_zoho_api($crm);
...
//
  ...
  if(!$is_admin && $event == 'submit' && $this->post('manual_export',$data) == "1"){ //if not admin (from webpage) , event is empty(sending new to crm) , manual export is yes
  continue;   
  } 
